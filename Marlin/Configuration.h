...
#define STRING_CONFIG_H_AUTHOR "(Nerdhaus Firmware)" // Who made the changes.
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  #else
    // Nerdhaus Ender 3, Tuned as of 2022-02-20
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  // #define DEFAULT_bedKp 130.94
  // #define DEFAULT_bedKi 24.43
  // #define DEFAULT_bedKd 467.88

  // Gulfcoast Robotics 450w heated bed pad with bed-mounted thermistor.
  // Slow to heat but holds temp like a champ.
  #define DEFAULT_bedKp 35.20
  #define DEFAULT_bedKi 0.80
  #define DEFAULT_bedKd 1030
...
#define NOZZLE_TO_PROBE_OFFSET_Z -2.175
...
#define THREE_POINT_LEVELING_SCREWS { { BED_SCREW_INSET, BED_SCREW_INSET }, { BED_SCREW_INSET, Y_BED_SIZE-BED_SCREW_INSET }, { X_BED_SIZE - abs(NOZZLE_TO_PROBE_OFFSET_X), Y_BED_SIZE/2 } }
